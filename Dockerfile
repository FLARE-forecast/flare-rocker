...
RUN R -e "for (i in 1:70) { devtools::install_github('FLARE-forecast/GLM3r', auth_token ='$PAT') }"
RUN R -e "for (i in 1:70) { devtools::install_github('hadley/assertthat', force = TRUE, auth_token ='$PAT') }"
